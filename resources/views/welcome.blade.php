...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="flex justify-center mt-4 mb-2">
        <div class="text-2xl animate-pulse">Fondation PXN : stream-stuff</div>
    </div>
    <div class="flex flex-col mt-10">
        <p class="flex justify-center text-lg">Accès agent R</p>
        <div class="flex justify-center text-md underline">
            <a class="mr-6" href="http://fondationpxn.com:50500/twitchLaravel/public/startingryry">starting</a>
