...
<div class="absolute left-64 top-52 flex flex-row-reverse">
    ...
    <div class="relative">
        <img class="rounded-2xl border-2 border-violet-900 border-opacity-40 shadow-xl" src="images/giphy1.gif" style="height: 540px; width: 960px" alt="">
    </div>
        <div class="animate-pulse absolute top-0.5 right-2 h-4 w-4 my-1 border-2 border-white rounded-full bg-red-600 z-2"></div>
</div>
<style>
